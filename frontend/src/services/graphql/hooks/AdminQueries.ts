...
export function useGetAdminsSuspenseQuery(
    baseOptions?:
        | Apollo.SkipToken
    ...
    return Apollo.useSuspenseQuery<GetAdminsQuery, GetAdminsQueryVariables>(
        GetAdminsDocument,
        options,
    );
}
...
>;
export type GetAdminsSuspenseQueryHookResult = ReturnType<
    typeof useGetAdminsSuspenseQuery
>;
